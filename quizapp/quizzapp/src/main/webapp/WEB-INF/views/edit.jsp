...
<body>
	...
	<a href="dummy"><button class="left">Cancel Edit</button></a>
	<div class="block1">
		<div class="form">
		
			<form action="editprocess">
				
					<% QuestionCreator creator=(QuestionCreator)request.getAttribute("creator"); %>
				<label for="Question">Question:</label> <input type="text"
					id="Question" name="Question" value="<%= creator.getQuestion() %>"
					 required>
				 <label for="option1">OPTION 1:</label> <input
					type="text" id="option1" name="option1" value=" <%= creator.getOption1() %>"> 
				<label for="option2">OPTION 2:</label> <input
					type="text" id="option2" name="option2" value="<%= creator.getOption2() %>"> 
				<label for="option3">OPTION 3:</label> <input
					type="text" id="option3" name="option3" value="<%= creator.getOption3() %>">
				<label for="option4">OPTION 4:</label> <input type="text"
					id="option4" name="option4" value="<%= creator.getOption4() %>">
